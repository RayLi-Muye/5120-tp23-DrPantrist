# FastAPI API for Vercel Serverless + Postgres (Neon / RDS / local).
...
def _normalize_database_url(url: str) -> str:
    """Accept postgres:// or postgresql:// and produce SQLAlchemy asyncpg URL."""
    u = url.strip()
...
class StripApiPrefixMiddleware(BaseHTTPMiddleware):
    """When mounted under /api on Vercel Services, route handlers stay un-prefixed."""
